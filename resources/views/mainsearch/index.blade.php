...
@section('content')
	...
	<legend>Ovas por descripcion</legend>
	@foreach($ovasdescription as $ovadescription)
		...
		<br>
	@endforeach
	<legend>Ovas por archivo</legend>
	...
	<legend>Ovas por categoria</legend>
	...
	<legend>Descripción categoría</legend>
	@foreach($categoriesdescription as $categorydescription)
		...
		<br>
	@endforeach
	<legend>Descripción tipo</legend>
	...
	<legend>Foros por nombre</legend>
	...
	<legend>Foros por caracteristicas</legend>
	...
	<legend>Ayudas por nombre</legend>
	...
	<legend>Ayudas por video</legend>
	@foreach($helpsvideo as $helpvideo)
		&nbsp;&nbsp;&nbsp;{{$helpvideo->video}}
		<a href="{{ route('member.helps.show',$helpvideo->id) }}" class="btn btn-warning" title="Ver Ayuda"><span class="glyphicon glyphicon-ok" aria-hidden="true"> Ver</span></a>
		<br>
	@endforeach

	<legend>Ayudas por descripción</legend>
	@foreach($helpsdescription as $helpdescription)
		&nbsp;&nbsp;&nbsp;{{$helpdescription->description}}
		<a href="{{ route('member.helps.show',$helpdescription->id) }}" class="btn btn-warning" title="Ver Ayuda"><span class="glyphicon glyphicon-ok" aria-hidden="true"> Ver</span></a>
		<br>
	@endforeach
